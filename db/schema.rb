...
ActiveRecord::Schema[7.1].define(version: 2026_05_12_194955) do
  ...
  create_table "app_users", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.string "expo_push_token_camioneta"
  ...
  create_table "check_checkeo_usuarios", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["app_user_id"], name: "index_check_checkeo_usuarios_on_app_user_id"
  ...
  create_table "check_checkeos", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.boolean "corregido_fuera_de_fecha"
    t.integer "extintor"
    t.integer "kit_derrame"
    t.boolean "botiquin"
    t.boolean "gata"
    t.boolean "cadenas"
    t.boolean "llave_rueda"
    t.boolean "antena_radio"
    t.boolean "permiso_circulacion"
    t.boolean "revision_tecnica"
    t.boolean "soap"
    t.boolean "alcohol"
    t.boolean "protector_solar"
    t.boolean "carpeta"
    t.boolean "panos_limpieza"
    t.boolean "conos"
    t.boolean "radio_comunicacion"
    t.boolean "espejo_inspeccion"
    t.boolean "toldo"
    t.boolean "pie_de_metro"
    t.boolean "tintas"
    t.boolean "arnes"
    t.integer "falta_diclofenaco_cant"
    t.integer "falta_guantes_cant"
    t.integer "falta_parche_curita_cant"
    t.integer "falta_gasa_cant"
    t.integer "falta_venda_cant"
    t.integer "falta_suero_cant"
    t.integer "falta_tela_adhesiva_cant"
    t.integer "falta_palitos_cant"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
